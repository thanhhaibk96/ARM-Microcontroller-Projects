...
//	while(UCAN_IsSystemReady() == false)
//	{
//	}
  /* Infinite loop */
  while (1)
  {	
//		UDELAY_ms(100);
//		UKELLER_GetStatus(&CAN_Data.KellerPA3_Status);
...
//			URC_SetAngle(RCServo_Angle);
//			RCServo_Angle += 10.0;
//			if(RCServo_Angle > 180.0) RCServo_Angle = 0.0;
//		UKELLER_GetStatus(&Status_Pressure_Sensor);
//		UKELLER_KELLER_ReadTOB1(250);
//		UMX28_setGoalPosition(254, _test_Goal_MX28);
//		_test_Goal_MX28 += 500;
//		if(_test_Goal_MX28 > 4095) _test_Goal_MX28 = 0;
//		UCAN_Transmit(0x123,8,CAN_Data);
//		UBMS40_Transmit("Chau Thanh Hai");
//		UDVL_Transmit("Chau Thanh Hai");
//		UMX28_Transmit("Chau Thanh Hai");
